...
export default class GUIManager extends Singleton {
  ...
  private globalCloseBtn: Laya.Image;
   ...
   * @param isGray
   */
  public showTouchBlockLayer(isGray?: boolean) {
   ...
   */
  public showBottomMenu(bottomMenu: BottomMenu) {
   ...
   * 返回底部菜单
   */
  public getBottomMenu(): BottomMenu{
    if(this.bottomMenu){

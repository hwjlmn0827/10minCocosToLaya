...
interface BridgeInterface {
     ...
     */
    setOpenPageUrlImeituanPrefix(imeituanUrlPrefix: string): any;
    /**
     ...
     * @param callback 取消该方法的监听
     */
    offShow(callback: () => void): any;
    /**
     * 开启全局关闭按钮的监听事件
     * 当监听事件存在时
     * @param callback 满足条件时会触发该方法
     */
    onBeforeClosePage(callback: () => void): any;
    /**
     * 取消监听小游戏回到前台的事件
     * @param callback 取消该方法的监听
     */
    offBeforeClosePage(callback: () => void): any;
    /**
     * 设置存储
     * @param key 存储key
     * @param value 存储值
     ...
     * @param object 分享参数
     */
    share(object: wx.ShareObject): any;
    /**
     * 跳转到设置
     * @param object
     */

...
export default class SpineManager extends Singleton {
    constructor() {
        ...
        this.templetMap = new Map();
        this.templetStateMap = new Map();
    }
    /**
     * 开启日志
     * @param enabled
     ...
     */
    loadSkeletonAsync(spineUrl, aniMode = 0) {
     ...
     * @param spineUrl
     */
    loadNewSpineSkeletonAsync(spineUrl) {
        return new Promise((resolve, reject) => {
     ...
     * @param spineUrl
     */
    loadNewSpineTempletAsync(spineUrl) {
        return new Promise((resolve, reject) => {
            if (!spineUrl) {

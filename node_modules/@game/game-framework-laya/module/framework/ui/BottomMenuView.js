...
export default class BottomMenuView extends Laya.View {
    ...
    onAnimationStart() {
        ...
        Laya.Tween.to(this.menu, {
            y: targetY
        }, 350, Laya.Ease.expoOut, Laya.Handler.create(this, () => {
            if (this.touchBlockLayer) {
    ...
    close() {
        ...
        Laya.Tween.to(this.menu, { y: Laya.stage.height }, 350, Laya.Ease.expoOut, Laya.Handler.create(this, this.onClosed));
    }
    onClosed() {
        this.menu.onClosed();
        this.destroy();

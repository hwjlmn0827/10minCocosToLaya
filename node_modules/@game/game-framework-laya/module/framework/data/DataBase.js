...
(function (DataParseType) {
    //整体替换
    DataParseType[DataParseType["replace"] = 0] = "replace";
    //差值合并
    DataParseType[DataParseType["merge"] = 1] = "merge";
...
class DataBase extends EventDispatcher {
     ...
     * @param isEnable
     */
    setEventUpdateEnabled(isEnable) {
     ...
     */
    setUpdateCheckEqual(updateCheckEqual) {

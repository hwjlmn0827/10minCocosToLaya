...
export default class MetricsUtil extends Singleton {
    constructor() {
        super(...arguments);
        this.jsStartTime = 0;
        this._isReportLoginSuccess = false;
     ...
     * @param tag
     */
    reportPerformance(type, value, tag) {
        if (this.logEnabled) {
